...
Not like magic in stories where trumpets knew what to do.
...
Then everything would know what she was worth.`
    },
    {
      id: "ch02_01",
      chapter: 2,
      title: "The path that fits",
      text: `The path did not look made.
...
It was made of folded paper and softened by mist.

Across the front, someone had written two words in red crayon.
...
It passed through June like it had somewhere else to be.`
    },
    {
      ...
      text: `A white moth settled on the end of June's sword.

Its wings opened and closed like two tiny doors.
...
The moth flew toward the windows, and June followed because welcome was a shape she still recognized.`
    },
    {
      id: "ch03_01",
      chapter: 3,
      title: "Welcome to Almost",
      text: `The town waited where no town should be.

Its roofs were steep.

Its windows were warm.

Its streets were swept clean of leaves, mud, and anything that had not been invited.
...
It felt less like a name than an excuse.`
    },
    {
      ...
      chapter: 3,
      title: "Saved chairs",
      text: `In every window, dinner was beginning.

Bowls steamed.

Lamps glowed.

Parents leaned close to hear small voices.

At every table, one chair sat empty.
...
As if every arrival began somewhere else, with someone asking what happened next.`
    },
    {
      id: "ch03_04",
      chapter: 3,
      title: "The almost family",
      text: `Then she saw them.

Her mother, but rested.

Her father, but listening.

Their kitchen table, but clean.

Their faces, but open.
...
That was how June knew it was not home.`
    },
    {
      ...
      text: `A girl sat between them.

She had June's hair.

June's eyes.

June's missing front tooth from two summers ago.

But she smiled at the right time.
...
Old dirt.`
    },
    {
      ...
      text: `The girl in the window lifted her hand.

Not to wave.

To show June the empty chair beside her.

The White Moth whispered near June's ear.
...
That was the unfair thing about fear.
...
June thought it was moving closer.

But when the streetlights blinked out, she saw the path instead.
...
None of them opened a door.`
    },
    {
      ...
      chapter: 4,
      title: "Beyond Almost",
      text: `Beyond Almost, the path stopped pretending to be kind.
...
And deciding had always been easier for everyone else.`
    },
    {
      ...
      text: `The lake waited at the bottom of the woods.

It was too still for water.
...
Not even a shadow.`
    },
    {
      ...
      chapter: 4,
      title: "No reflection",
      text: `She touched the surface.

The lake did not ripple.

It accepted her hand the way a room accepts silence.
...
No house becomes safe just because someone finally notices the fire.

But her father turned off the television.

Her mother sat in the grass beside her until June could speak.

And when June said she did not want to be alone, someone heard her.`
    },
    main: {
      id: "main",
      title: "What Remained",
